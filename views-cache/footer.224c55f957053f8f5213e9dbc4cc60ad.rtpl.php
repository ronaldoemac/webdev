            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Rcode Desenv</h2>
                        <p>Desenvolvimento de Estilos de Framework para consolidação de ferramentas/procedimentos operacionais.</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        ...
                        <p>Framework em desenvolvimento!</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2019 Rcode Desenv. <a href="http://www.rcodebr.com.br" target="_blank">rcodebr.com.br</a></p>
                    </div>
                </div>
